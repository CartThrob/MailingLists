...
class MCAPI
{
     ...
     */
    public function templates($types = [
     ...
     * @return bool true if the template was updated, otherwise an error will be thrown
     */
     ...
     * @return bool true if the template was deleted, otherwise an error will be thrown
     */
